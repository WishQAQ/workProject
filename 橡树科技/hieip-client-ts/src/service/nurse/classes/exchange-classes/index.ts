...
import {ApiClassesExchange} from 'pkg/api/nurse'
import {NurseExchangeClassesModelDtoClasses} from 'pkg/entity/nurse'
import {message} from 'pkg/common/message'

export interface ExchangeClassesState {// 声明类型
    /** 调班审批数据 */
    tableData?: Array<NurseExchangeClassesModelDtoClasses>,
    /** 分页加载开始项 */
    startIndex?: number,
    /** 每页加载条数 */
    pageSize?: number,
    ...
    open?: boolean,
    /** * 选中行 */
    selectedData?: Array<NurseExchangeClassesModelDtoClasses>,
    /** * 开始时间 */
    begin?: any,
    /** * 结束时间 */
    end?: any,
...
class ExchangeClassesService extends BaseService<ExchangeClassesState> {
    agApi?: any // AG列表的api
    defaultState = { // 初始化
        tableData: [],
        startIndex: 1,
     ...
     */
    getCurrentState = (e) => {
        this.dispatch({state: e.target.value})
        this.search()
    }
    /**
     * 搜索按钮
    ...
    getSelectRows = () => {
        ...
        this.dispatch2({selectedData: data})
    }
    /**
     * 修改状态
     * 参数:n (3：同意；4：拒绝)
...
export const exchangeClassesService = new ExchangeClassesService('exchangeClasses')