...
var Toaster = /** @class */ (function (_super) {
    ...
    Toaster.create = function (props, container) {
        ...
        return ReactDOM.render(React.createElement(Toaster, tslib_1.__assign({}, props, { usePortal: false })), containerElement);
    };
