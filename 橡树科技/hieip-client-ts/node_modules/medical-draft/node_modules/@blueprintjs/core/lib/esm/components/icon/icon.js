...
var Icon = /** @class */ (function (_super) {
    ...
    Icon.prototype.render = function () {
        var _a = this.props, className = _a.className, icon = _a.icon, _b = _a.iconSize, iconSize = _b === void 0 ? Icon.SIZE_STANDARD : _b, intent = _a.intent, svgProps = tslib_1.__rest(_a, ["className", "icon", "iconSize", "intent"]);
        if (icon == null) {
            return null;
        }
        ...
        return (React.createElement("svg", tslib_1.__assign({}, svgProps, { className: classes, "data-icon": icon, width: iconSize, height: iconSize, viewBox: viewBox }),
