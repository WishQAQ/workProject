...
export declare class MenuItem extends React.PureComponent<IMenuItemProps & React.AnchorHTMLAttributes<HTMLAnchorElement>> {
    static defaultProps: IMenuItemProps;
    static displayName: string;
    render(): JSX.Element;
    private maybeRenderLabel(labelElement?);
    private maybeRenderPopover(target, children?);
}
