...
var Callout = /** @class */ (function (_super) {
    ...
    Callout.prototype.render = function () {
        ...
        var classes = classNames(common_1.Classes.CALLOUT, common_1.Classes.intentClass(intent), className);
        var maybeIcon = iconName === undefined ? (undefined) : (React.createElement("span", { className: common_1.Classes.CALLOUT_ICON },
            React.createElement(index_1.Icon, { icon: iconName, iconSize: index_1.Icon.SIZE_LARGE })));
        var maybeTitle = title === undefined ? undefined : React.createElement("h4", { className: common_1.Classes.CALLOUT_TITLE }, title);
