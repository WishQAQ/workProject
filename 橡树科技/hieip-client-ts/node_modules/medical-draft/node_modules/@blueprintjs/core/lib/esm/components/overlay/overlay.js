...
var Overlay = /** @class */ (function (_super) {
    ...
    Overlay.prototype.render = function () {
        ...
        var childrenWithTransitions = React.Children.map(children, function (child) {
            ...
            return (React.createElement(CSSTransition, { classNames: transitionName, timeout: transitionDuration }, decoratedChild));
        });
        var transitionGroup = (React.createElement(TransitionGroup, { appear: true },
    ...
    Overlay.prototype.maybeRenderBackdrop = function () {
        ...
        if (hasBackdrop && isOpen) {
            return (React.createElement(CSSTransition, { classNames: transitionName, timeout: transitionDuration },
