...
var AbstractButton = /** @class */ (function (_super) {
    ...
    AbstractButton.prototype.getCommonButtonProps = function () {
        var _a = this.props, alignText = _a.alignText, loading = _a.loading;
    ...
    AbstractButton.prototype.renderChildren = function () {
        ...
        return (React.createElement(React.Fragment, null,
            loading && React.createElement(spinner_1.Spinner, { className: classNames(Classes.SMALL, Classes.BUTTON_SPINNER) }),
            React.createElement(icon_1.Icon, { icon: icon }),
            (text || children) && (React.createElement("span", { className: Classes.BUTTON_TEXT },
                text,
                children)),
