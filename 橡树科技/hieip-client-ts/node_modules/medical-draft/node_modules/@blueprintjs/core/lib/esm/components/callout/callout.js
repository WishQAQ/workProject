...
var Callout = /** @class */ (function (_super) {
    ...
    Callout.prototype.render = function () {
        ...
        var classes = classNames(Classes.CALLOUT, Classes.intentClass(intent), className);
        var maybeIcon = iconName === undefined ? (undefined) : (React.createElement("span", { className: Classes.CALLOUT_ICON },
            React.createElement(Icon, { icon: iconName, iconSize: Icon.SIZE_LARGE })));
        var maybeTitle = title === undefined ? undefined : React.createElement("h4", { className: Classes.CALLOUT_TITLE }, title);
