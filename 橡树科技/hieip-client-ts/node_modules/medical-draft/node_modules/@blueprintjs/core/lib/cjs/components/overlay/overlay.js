...
var Overlay = /** @class */ (function (_super) {
    ...
    function Overlay(props, context) {
        ...
        _this.handleDocumentClick = function (e) {
            ...
            var stackIndex = openStack.indexOf(_this);
            var isClickInThisOverlayOrDescendant = openStack
                .slice(stackIndex)
                .some(function (_a) {
                var containerElement = _a.containerElement;
                return containerElement && containerElement.contains(eventTarget);
            });
    ...
    Overlay.prototype.render = function () {
        ...
        var _a = this.props, children = _a.children, className = _a.className, usePortal = _a.usePortal, isOpen = _a.isOpen, transitionDuration = _a.transitionDuration, transitionName = _a.transitionName;
        var childrenWithTransitions = React.Children.map(children, function (child) {
            ...
            var decoratedChild = React.cloneElement(child, {
                className: classNames(child.props.className, Classes.OVERLAY_CONTENT),
                tabIndex: 0,
            });
            return (React.createElement(react_transition_group_1.CSSTransition, { classNames: transitionName, timeout: transitionDuration }, decoratedChild));
        });
        var transitionGroup = (React.createElement(react_transition_group_1.TransitionGroup, { appear: true },
    ...
    Overlay.prototype.maybeRenderBackdrop = function () {
        ...
        if (hasBackdrop && isOpen) {
            return (React.createElement(react_transition_group_1.CSSTransition, { classNames: transitionName, timeout: transitionDuration },
    ...
    Overlay.displayName = "Blueprint2.Overlay";
