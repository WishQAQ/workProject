...
var MenuItem = /** @class */ (function (_super) {
    ...
    MenuItem.prototype.render = function () {
        var _a = this.props, className = _a.className, children = _a.children, disabled = _a.disabled, icon = _a.icon, intent = _a.intent, labelElement = _a.labelElement, multiline = _a.multiline, popoverProps = _a.popoverProps, shouldDismissPopover = _a.shouldDismissPopover, text = _a.text, htmlProps = tslib_1.__rest(_a, ["className", "children", "disabled", "icon", "intent", "labelElement", "multiline", "popoverProps", "shouldDismissPopover", "text"]);
        var hasSubmenu = children != null;
        var anchorClasses = classNames(Classes.MENU_ITEM, Classes.intentClass(intent), (_b = {},
    ...
    MenuItem.prototype.maybeRenderPopover = function (target, children) {
        ...
        return (React.createElement(popover_1.Popover, tslib_1.__assign({ disabled: disabled, enforceFocus: false, hoverCloseDelay: 0, interactionKind: popover_1.PopoverInteractionKind.HOVER, modifiers: SUBMENU_POPOVER_MODIFIERS, position: position_1.Position.RIGHT_TOP, usePortal: false }, popoverProps, { content: React.createElement(menu_1.Menu, null, children), minimal: true, popoverClassName: classNames(Classes.MENU_SUBMENU, popoverProps.popoverClassName), target: target })));
    };
    ...
    MenuItem.displayName = "Blueprint2.MenuItem";
    return MenuItem;
}(React.PureComponent));
