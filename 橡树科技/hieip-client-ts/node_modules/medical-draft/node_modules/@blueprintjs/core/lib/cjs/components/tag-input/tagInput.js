...
var TagInput = /** @class */ (function (_super) {
    ...
    function TagInput() {
        ...
        _this.maybeRenderTag = function (tag, index) {
            ...
            return (React.createElement(tag_1.Tag, tslib_1.__assign({ active: index === _this.state.activeIndex, "data-tag-index": index, key: tag + "__" + index, onRemove: _this.props.disabled ? null : _this.handleRemoveTag }, props), tag));
        };
    ...
    TagInput.prototype.render = function () {
        var _a = this.props, className = _a.className, inputProps = _a.inputProps, leftIcon = _a.leftIcon, placeholder = _a.placeholder, values = _a.values;
        var classes = classNames(Classes.INPUT, Classes.TAG_INPUT, (_b = {},
        ...
        return (React.createElement("div", { className: classes, onBlur: this.handleContainerBlur, onClick: this.handleContainerClick },
            ...
            React.createElement("div", { className: Classes.TAG_INPUT_VALUES },
                ...
                this.props.children,
                React.createElement("input", tslib_1.__assign({ value: this.state.inputValue }, inputProps, { onFocus: this.handleInputFocus, onChange: this.handleInputChange, onKeyDown: this.handleInputKeyDown, onKeyUp: this.handleInputKeyUp, placeholder: resolvedPlaceholder, ref: this.refHandlers.input, className: classNames(Classes.INPUT_GHOST, inputProps.className), disabled: this.props.disabled }))),
    ...
    TagInput.displayName = "Blueprint2.TagInput";
