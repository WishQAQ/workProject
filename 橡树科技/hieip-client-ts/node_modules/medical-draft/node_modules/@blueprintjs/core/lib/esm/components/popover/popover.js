...
var Popover = /** @class */ (function (_super) {
    ...
    Popover.prototype.render = function () {
        ...
        var target = React.cloneElement(children.target, {
            className: classNames(children.target.props.className, (_c = {},
        ...
        return (React.createElement(Manager, { tag: this.props.rootElementTag, className: classNames(Classes.POPOVER_WRAPPER, className) },
            React.createElement(Target, tslib_1.__assign({}, targetProps, { innerRef: this.refHandlers.target }), target),
            React.createElement(Overlay, { autoFocus: this.props.autoFocus, backdropClassName: Classes.POPOVER_BACKDROP, backdropProps: this.props.backdropProps, canEscapeKeyClose: this.props.canEscapeKeyClose, canOutsideClickClose: this.props.interactionKind === PopoverInteractionKind.CLICK, className: this.props.portalClassName, didOpen: this.handleContentMount, enforceFocus: this.props.enforceFocus, hasBackdrop: hasBackdrop, usePortal: this.props.usePortal, isOpen: isOpen && !isContentEmpty, onClose: this.handleOverlayClose, transitionDuration: this.props.transitionDuration, transitionName: Classes.POPOVER }, this.renderPopper(children.content))));
        var _b, _c;
    };
    ...
    Popover.prototype.renderPopper = function (content) {
        ...
        var placement = positionToPlacement(this.props.position);
        return (React.createElement(Popper, { className: Classes.TRANSITION_CONTAINER, placement: placement, modifiers: allModifiers },
            React.createElement("div", tslib_1.__assign({ className: popoverClasses, ref: this.refHandlers.popover, style: { transformOrigin: this.state.transformOrigin } }, popoverHandlers),
                isArrowEnabled ? React.createElement(PopoverArrow, { angle: this.state.arrowRotation }) : undefined,
