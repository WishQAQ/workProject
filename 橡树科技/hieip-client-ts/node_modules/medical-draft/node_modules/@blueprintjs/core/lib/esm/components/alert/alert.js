...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        ...
        return (React.createElement(Dialog, { className: classNames(Classes.ALERT, className), canEscapeKeyClose: this.props.canEscapeKeyCancel, canOutsideClickClose: this.props.canOutsideClickCancel, isOpen: this.props.isOpen, onClose: this.handleCancel, style: this.props.style, transitionDuration: this.props.transitionDuration },
