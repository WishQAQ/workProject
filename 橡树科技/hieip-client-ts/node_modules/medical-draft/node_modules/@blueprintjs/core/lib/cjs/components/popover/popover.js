...
var Popover = /** @class */ (function (_super) {
    ...
    Popover.prototype.render = function () {
        ...
        return (React.createElement(react_popper_1.Manager, { tag: this.props.rootElementTag, className: classNames(Classes.POPOVER_WRAPPER, className) },
            React.createElement(react_popper_1.Target, tslib_1.__assign({}, targetProps, { innerRef: this.refHandlers.target }), target),
            React.createElement(overlay_1.Overlay, { autoFocus: this.props.autoFocus, backdropClassName: Classes.POPOVER_BACKDROP, backdropProps: this.props.backdropProps, canEscapeKeyClose: this.props.canEscapeKeyClose, canOutsideClickClose: this.props.interactionKind === PopoverInteractionKind.CLICK, className: this.props.portalClassName, didOpen: this.handleContentMount, enforceFocus: this.props.enforceFocus, hasBackdrop: hasBackdrop, usePortal: this.props.usePortal, isOpen: isOpen && !isContentEmpty, onClose: this.handleOverlayClose, transitionDuration: this.props.transitionDuration, transitionName: Classes.POPOVER }, this.renderPopper(children.content))));
        var _b, _c;
    };
