...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.render = function () {
        ...
        var tabTitles = React.Children.map(this.props.children, function (child) { return (Utils.isElementOfType(child, Tab) ? _this.renderTabTitle(child) : child); });
    ...
    Tabs.displayName = "Blueprint2.Tabs";
    return Tabs;
