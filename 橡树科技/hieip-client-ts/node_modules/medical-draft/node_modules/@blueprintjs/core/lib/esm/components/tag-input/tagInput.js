...
var TagInput = /** @class */ (function (_super) {
    ...
    function TagInput() {
        ...
        _this.maybeRenderTag = function (tag, index) {
            ...
            return (React.createElement(Tag, tslib_1.__assign({ active: index === _this.state.activeIndex, "data-tag-index": index, key: tag + "__" + index, onRemove: _this.props.disabled ? null : _this.handleRemoveTag }, props), tag));
        };
