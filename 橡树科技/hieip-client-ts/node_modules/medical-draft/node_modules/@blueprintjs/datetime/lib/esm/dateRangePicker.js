...
import { AbstractPureComponent, Classes, Menu, MenuItem, Utils } from "@blueprintjs/core";
...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    function DateRangePicker(props, context) {
        ...
        _this.handleLeftMonthChange = function (newDate) {
            var leftView = new MonthAndYear(newDate.getMonth(), newDate.getFullYear());
        ...
        _this.handleRightMonthChange = function (newDate) {
            var rightView = new MonthAndYear(newDate.getMonth(), newDate.getFullYear());
        ...
        */
        ...
        _this.handleRightYearSelectChange = function (rightDisplayYear) {
            ...
            var minMonthAndYear = new MonthAndYear(adjustedMinDate.getMonth(), adjustedMinDate.getFullYear());
            var maxMonthAndYear = new MonthAndYear(maxDate.getMonth(), maxDate.getFullYear());
    ...
    DateRangePicker.prototype.render = function () {
        var modifiers = combineModifiers(this.modifiers, this.props.modifiers);
        ...
        var dayPickerBaseProps = tslib_1.__assign({ locale: locale,
            ...
            modifiers: modifiers, showOutsideDays: true }, dayPickerProps, { disabledDays: disabledDays, onDayClick: this.handleDayClick, onDayMouseEnter: this.handleDayMouseEnter, onDayMouseLeave: this.handleDayMouseLeave, selectedDays: this.state.value });
    ...
    DateRangePicker.prototype.maybeRenderShortcuts = function () {
        ...
        var shortcutElements = shortcuts.map(function (s, i) {
            return (React.createElement(MenuItem, { className: Classes.POPOVER_DISMISS_OVERRIDE, disabled: !_this.isShortcutInRange(s.dateRange), key: i, onClick: _this.getShorcutClickHandler(s.dateRange), text: s.label }));
        });
    ...
    DateRangePicker.displayName = "Blueprint2.DateRangePicker";
...
function getStateChange(value, nextValue, state, contiguousCalendarMonths) {
    ...
    if (value != null && nextValue == null) {
        ...
        if (nextValueStart == null && nextValueEnd != null) {
            var nextValueEndMonthAndYear = new MonthAndYear(nextValueEnd.getMonth(), nextValueEnd.getFullYear());
            ...
            var nextValueStartMonthAndYear = new MonthAndYear(nextValueStart.getMonth(), nextValueStart.getFullYear());
