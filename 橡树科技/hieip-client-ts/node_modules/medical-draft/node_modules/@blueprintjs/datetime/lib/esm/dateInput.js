...
import { AbstractPureComponent, InputGroup, Intent, Keys, Popover, Utils, } from "@blueprintjs/core";
...
var DateInput = /** @class */ (function (_super) {
    ...
    function DateInput() {
        ...
        _this.handleDateChange = function (newDate, hasUserManuallySelectedDate, didSubmitWithEnter) {
            ...
            Utils.safeInvoke(_this.props.onChange, newDate);
        };
        ...
        _this.handleInputChange = function (e) {
            ...
            if (isDateValid(value) && _this.isDateInRange(value)) {
                ...
                Utils.safeInvoke(_this.props.onChange, value);
            }
            else {
        ...
        _this.handleInputBlur = function (e) {
            ...
            if (valueString.length > 0 &&
                ...
                if (isNaN(date.valueOf())) {
                    ...
                    Utils.safeInvoke(_this.props.onChange, date);
                }
            }
            else {
                if (valueString.length === 0) {
    ...
    DateInput.prototype.render = function () {
        ...
        return (React.createElement(Popover, tslib_1.__assign({ isOpen: this.state.isOpen && !this.props.disabled, usePortal: false }, popoverProps, { autoFocus: false, className: classNames(popoverProps.className, this.props.className), content: wrappedPopoverContent, enforceFocus: false, onClose: this.handleClosePopover, popoverClassName: classNames("pt-dateinput-popover", popoverProps.popoverClassName) }),
    ...
    DateInput.displayName = "Blueprint2.DateInput";
