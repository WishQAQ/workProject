...
import { AbstractPureComponent, Classes, InputGroup, Intent, Keys, Popover, Position, Utils, } from "@blueprintjs/core";
import { DateRangeBoundary, isDateValid, isDayInRange } from "./common/dateUtils";
...
var DateRangeInput = /** @class */ (function (_super) {
    ...
    DateRangeInput.prototype.render = function () {
        ...
        return (React.createElement(Popover, tslib_1.__assign({ isOpen: this.state.isOpen, position: Position.BOTTOM_LEFT, usePortal: false }, this.props.popoverProps, { autoFocus: false, className: popoverClassName, content: popoverContent, enforceFocus: false, onClose: this.handlePopoverClose }),
    ...
    DateRangeInput.displayName = "Blueprint2.DateRangeInput";
