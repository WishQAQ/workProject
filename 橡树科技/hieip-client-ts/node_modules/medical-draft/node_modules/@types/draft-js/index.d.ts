...
declare namespace Draft {
  ...
  namespace Model {
    ...
    export namespace Encoding {
      ...
      export function convertFromHTMLtoContentBlocks(html: string, DOMBuilder?: Function, blockRenderMap?: DraftBlockRenderMap): { contentBlocks: Array<ContentBlock>, entityMap: any };

      export function convertFromRawToDraftState(rawState: RawDraftContentState): ContentState;

      export function convertFromDraftStateToRaw(contentState: ContentState): RawDraftContentState;
    }
    ...
    namespace ImmutableData {
      ...
      export type BlockMap = Immutable.OrderedMap<string, Draft.Model.ImmutableData.ContentBlock>;
