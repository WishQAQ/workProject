...
import { AbstractComponent, Classes, InputGroup, Keys, Popover, Position, Utils, } from "@blueprintjs/core";
import { DateRangeBoundary, fromDateRangeToMomentDateRange, fromDateToMoment, fromMomentToDate, isMomentInRange, isMomentNull, isMomentValidAndInRange, momentToString, stringToMoment, } from "./common/dateUtils";
...
var DateRangeInput = (function (_super) {
    ...
    function DateRangeInput(props, context) {
        ...
        _this.handleDateRangePickerChange = function (selectedRange, didSubmitWithEnter) {
            ...
            var _a = fromDateRangeToMomentDateRange(selectedRange), selectedStart = _a[0], selectedEnd = _a[1];
            var isOpen = true;
            ...
            else if (_this.state.lastFocusedField === DateRangeBoundary.START) {
        ...
        _this.handleDateRangePickerHoverChange = function (hoveredRange, _hoveredDay, hoveredBoundary) {
            ...
            if (hoveredRange == null) {
                ...
                var isEndInputFocused = _this.state.boundaryToModify === DateRangeBoundary.END;
                _this.setState({
                    endHoverString: null,
                    isEndInputFocused: isEndInputFocused,
                ...
                var _a = fromDateRangeToMomentDateRange(hoveredRange), hoveredStart = _a[0], hoveredEnd = _a[1];
                var isStartInputFocused = hoveredBoundary != null ? hoveredBoundary === DateRangeBoundary.START : _this.state.isStartInputFocused;
                var isEndInputFocused = hoveredBoundary != null ? hoveredBoundary === DateRangeBoundary.END : _this.state.isEndInputFocused;
                _this.setState({
        ...
        _this.handleStartInputEvent = function (e) {
            _this.handleInputEvent(e, DateRangeBoundary.START);
        };
        _this.handleEndInputEvent = function (e) {
            _this.handleInputEvent(e, DateRangeBoundary.END);
        };
        ...
        _this.handleInputKeyDown = function (e) {
            ...
            var wasStartFieldFocused = _this.state.lastFocusedField === DateRangeBoundary.START;
            var wasEndFieldFocused = _this.state.lastFocusedField === DateRangeBoundary.END;
            ...
            if (isTabPressed) {
                ...
                var nextStartValue = _this.dateStringToMoment(_this.state.startInputString);
                var nextStartDate = fromMomentToDate(nextStartValue);
                var nextEndDate = isMomentNull(selectedEnd) ? undefined : fromMomentToDate(selectedEnd);
                _this.handleDateRangePickerChange([nextStartDate, nextEndDate], true);
            }
            else if (wasEndFieldFocused && isEnterPressed) {
                var nextStartDate = isMomentNull(selectedStart) ? undefined : fromMomentToDate(selectedStart);
                var nextEndValue = _this.dateStringToMoment(_this.state.endInputString);
                var nextEndDate = fromMomentToDate(nextEndValue);
                _this.handleDateRangePickerChange([nextStartDate, nextEndDate], true);
            }
            else {
        ...
        _this.handleInputBlur = function (_e, boundary) {
            ...
            if (_this.isInputEmpty(values.inputString)) {
                ...
                Utils.safeInvoke(_this.props.onError, _this.getDateRangeForCallback(maybeNextValue, boundary));
            }
        ...
        _this.handleInputChange = function (e, boundary) {
            ...
            if (inputString.length === 0) {
                ...
                Utils.safeInvoke(_this.props.onChange, _this.getDateRangeForCallback(moment(null), boundary));
            }
                ...
                if (_this.isNextDateRangeValid(maybeNextValue, boundary)) {
                    Utils.safeInvoke(_this.props.onChange, _this.getDateRangeForCallback(maybeNextValue, boundary));
                }
            }
            else {
        ...
        _this.dateStringToMoment = function (dateString) {
            ...
            return stringToMoment(dateString, _this.props.format, _this.props.locale);
        };
        ...
        _this.getSelectedRange = function () {
            ...
            var selectedEnd;
            if (_this.isControlled()) {
                _a = _this.props.value.map(fromDateToMoment), selectedStart = _a[0], selectedEnd = _a[1];
            }
            else {
            ...
            var doBoundaryDatesOverlap = _this.doBoundaryDatesOverlap(selectedStart, DateRangeBoundary.START);
            ...
            return momentDateRange.map(function (selectedBound) {
                return _this.isMomentValidAndInRange(selectedBound) ? fromMomentToDate(selectedBound) : undefined;
            });
            var _a;
        };
        ...
        _this.getInputPlaceholderString = function (boundary) {
            var isStartBoundary = boundary === DateRangeBoundary.START;
            var isEndBoundary = boundary === DateRangeBoundary.END;
            var inputProps = _this.getInputProps(boundary);
        ...
        _this.getInputProps = function (boundary) {
            return boundary === DateRangeBoundary.START ? _this.props.startInputProps : _this.props.endInputProps;
        };
        _this.getInputRef = function (boundary) {
            return boundary === DateRangeBoundary.START ? _this.refHandlers.startInputRef : _this.refHandlers.endInputRef;
        };
        _this.getFormattedDateString = function (momentDate, formatOverride) {
            if (isMomentNull(momentDate)) {
                ...
                var format = formatOverride == null ? _this.props.format : formatOverride;
                return momentToString(momentDate, format, _this.props.locale);
            }
        };
        _this.getStateKeysAndValuesForBoundary = function (boundary) {
            var controlledRange = fromDateRangeToMomentDateRange(_this.props.value);
        ...
        _this.doesEndBoundaryOverlapStartBoundary = function (boundaryDate, boundary) {
            return boundary === DateRangeBoundary.START ? false : _this.doBoundaryDatesOverlap(boundaryDate, boundary);
        };
        ...
        _this.isMomentValidAndInRange = function (momentDate) {
            return isMomentValidAndInRange(momentDate, _this.props.minDate, _this.props.maxDate);
        };
        _this.isMomentInRange = function (momentDate) {
            return isMomentInRange(momentDate, _this.props.minDate, _this.props.maxDate);
        };
        _this.reset(props);
        return _this;
    }
    ...
    DateRangeInput.prototype.render = function () {
        ...
        return (React.createElement(Popover, tslib_1.__assign({ inline: true, isOpen: this.state.isOpen, position: Position.BOTTOM_LEFT }, this.props.popoverProps, { autoFocus: false, className: popoverClassName, content: popoverContent, enforceFocus: false, onClose: this.handlePopoverClose }),
