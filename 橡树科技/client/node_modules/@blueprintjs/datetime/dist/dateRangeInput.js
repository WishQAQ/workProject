...
var DateRangeInput = (function (_super) {
    ...
    function DateRangeInput(props, context) {
        ...
        _this.handleInputKeyDown = function (e) {
            ...
            if (isTabPressed) {
                ...
                var nextStartDate = dateUtils_1.fromMomentToDate(nextStartValue);
                var nextEndDate = dateUtils_1.isMomentNull(selectedEnd) ? undefined : dateUtils_1.fromMomentToDate(selectedEnd);
                _this.handleDateRangePickerChange([nextStartDate, nextEndDate], true);
            }
            else if (wasEndFieldFocused && isEnterPressed) {
                var nextStartDate = dateUtils_1.isMomentNull(selectedStart) ? undefined : dateUtils_1.fromMomentToDate(selectedStart);
                var nextEndValue = _this.dateStringToMoment(_this.state.endInputString);
                var nextEndDate = dateUtils_1.fromMomentToDate(nextEndValue);
                _this.handleDateRangePickerChange([nextStartDate, nextEndDate], true);
            }
            else {
        ...
        _this.dateStringToMoment = function (dateString) {
            ...
            return dateUtils_1.stringToMoment(dateString, _this.props.format, _this.props.locale);
        };
        ...
        _this.getFormattedDateString = function (momentDate, formatOverride) {
            if (dateUtils_1.isMomentNull(momentDate)) {
                ...
                return dateUtils_1.momentToString(momentDate, format, _this.props.locale);
            }
        };
    ...
    DateRangeInput.prototype.render = function () {
        ...
        return (React.createElement(core_1.Popover, tslib_1.__assign({ inline: true, isOpen: this.state.isOpen, position: core_1.Position.BOTTOM_LEFT }, this.props.popoverProps, { autoFocus: false, className: popoverClassName, content: popoverContent, enforceFocus: false, onClose: this.handlePopoverClose }),
