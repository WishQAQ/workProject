...
export declare function momentToString(momentDate: moment.Moment, format: DateFormat, locale: string | undefined): string;
export declare function stringToMoment(dateString: string, format: DateFormat, locale: string | undefined): moment.Moment;
