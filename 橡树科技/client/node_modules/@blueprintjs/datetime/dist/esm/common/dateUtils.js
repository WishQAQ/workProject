...
export function isMomentNull(momentDate) {
    return momentDate.parsingFlags().nullInput;
}
export function isMomentValidAndInRange(momentDate, minDate, maxDate) {
    return momentDate.isValid() && isMomentInRange(momentDate, minDate, maxDate);
}
export function isMomentInRange(momentDate, minDate, maxDate) {
 ...
 */
export function fromDateToMoment(date) {
    if (date == null) {
 ...
 * This is a no-op unless moment-timezone's setDefault has been called.
 */
export function fromMomentToDate(momentDate) {
    if (momentDate == null) {
        return undefined;
    }
    else {
 ...
 * called).
 */
export function fromDateRangeToMomentDateRange(dateRange) {
    if (dateRange == null) {
        return undefined;
    }
 ...
 * been called.
 */
export function fromMomentDateRangeToDateRange(momentDateRange) {
 ...
 */
export function toLocalizedDateString(momentDate, format, locale) {
    var adjustedMomentDate = locale != null ? momentDate.locale(locale) : momentDate;
    return adjustedMomentDate.format(format);
}
export function momentToString(momentDate, format, locale) {
...
export function stringToMoment(dateString, format, locale) {
    if (typeof format === "string") {
        return moment(dateString, format, locale);
    }
    else {
        var date = format.stringToDate(dateString);
