...
var Table = (function (_super) {
    ...
    function Table(props, context) {
        ...
        _this.columnHeaderCellRenderer = function (columnIndex) {
            ...
            var id = props.id, loadingOptions = props.loadingOptions, renderCell = props.renderCell, renderColumnHeaderCell = props.renderColumnHeader, spreadableProps = tslib_1.__rest(props, ["id", "loadingOptions", "renderCell", "renderColumnHeader"]);
            ...
            var tableUseInteractionBar = _this.props.useInteractionBar;
            if (renderColumnHeaderCell != null) {
                var columnHeaderCell = renderColumnHeaderCell(columnIndex);
            ...
            var baseProps = tslib_1.__assign({ index: columnIndex, loading: columnLoading, useInteractionBar: tableUseInteractionBar }, spreadableProps);
            if (props.name != null) {
        ...
        _this.renderColumnHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenColumnsOnly) {
            ...
            var _b = _this.props, allowMultipleSelection = _b.allowMultipleSelection, fillBodyWithGhostCells = _b.fillBodyWithGhostCells, isColumnReorderable = _b.isColumnReorderable, isColumnResizable = _b.isColumnResizable, loadingOptions = _b.loadingOptions, maxColumnWidth = _b.maxColumnWidth, minColumnWidth = _b.minColumnWidth, selectedRegionTransform = _b.selectedRegionTransform;
            var classes = classNames(Classes.TABLE_COLUMN_HEADERS, (_c = {},
                ...
                _c));
            var columnIndices = _this.grid.getColumnIndicesInRect(viewportRect, fillBodyWithGhostCells);
            ...
            return (React.createElement("div", { className: classes },
                React.createElement(ColumnHeader, { allowMultipleSelection: allowMultipleSelection, cellRenderer: _this.columnHeaderCellRenderer, focusedCell: focusedCell, grid: _this.grid, isReorderable: isColumnReorderable, isResizable: isColumnResizable, loading: _this.hasLoadingOption(loadingOptions, TableLoadingOption.COLUMN_HEADERS), locator: _this.locator, maxColumnWidth: maxColumnWidth, measurableElementRef: refHandler, minColumnWidth: minColumnWidth, onColumnWidthChanged: _this.handleColumnWidthChanged, onFocus: _this.handleFocus, onLayoutLock: _this.handleLayoutLock, onReordered: _this.handleColumnsReordered, onReordering: reorderingHandler, onResizeGuide: resizeHandler, onSelection: _this.getEnabledSelectionHandler(RegionCardinality.FULL_COLUMNS), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd }, _this.props.children),
        ...
        _this.renderRowHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenRowsOnly) {
            ...
            var _a = _this.state, focusedCell = _a.focusedCell, selectedRegions = _a.selectedRegions, viewportRect = _a.viewportRect;
            var _b = _this.props, allowMultipleSelection = _b.allowMultipleSelection, fillBodyWithGhostCells = _b.fillBodyWithGhostCells, isRowReorderable = _b.isRowReorderable, isRowResizable = _b.isRowResizable, loadingOptions = _b.loadingOptions, maxRowHeight = _b.maxRowHeight, minRowHeight = _b.minRowHeight, renderRowHeader = _b.renderRowHeader, selectedRegionTransform = _b.selectedRegionTransform;
            var classes = classNames(Classes.TABLE_ROW_HEADERS, (_c = {},
                ...
                _c));
            var rowIndices = _this.grid.getRowIndicesInRect(viewportRect, fillBodyWithGhostCells);
            ...
            return (React.createElement("div", { className: classes, ref: refHandler },
                React.createElement(RowHeader, { allowMultipleSelection: allowMultipleSelection, focusedCell: focusedCell, grid: _this.grid, locator: _this.locator, isReorderable: isRowReorderable, isResizable: isRowResizable, loading: _this.hasLoadingOption(loadingOptions, TableLoadingOption.ROW_HEADERS), maxRowHeight: maxRowHeight, minRowHeight: minRowHeight, onFocus: _this.handleFocus, onLayoutLock: _this.handleLayoutLock, onResizeGuide: resizeHandler, onReordered: _this.handleRowsReordered, onReordering: reorderingHandler, onRowHeightChanged: _this.handleRowHeightChanged, onSelection: _this.getEnabledSelectionHandler(RegionCardinality.FULL_ROWS), renderRowHeader: renderRowHeader, selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd }),
                _this.maybeRenderRegions(_this.styleRowHeaderRegion)));
            var _c;
        };
        _this.bodyCellRenderer = function (rowIndex, columnIndex) {
            var _a = _this.getColumnProps(columnIndex), id = _a.id, loadingOptions = _a.loadingOptions, renderCell = _a.renderCell, renderColumnHeader = _a.renderColumnHeader, name = _a.name, renderName = _a.renderName, useInteractionBar = _a.useInteractionBar, restColumnProps = tslib_1.__rest(_a, ["id", "loadingOptions", "renderCell", "renderColumnHeader", "name", "renderName", "useInteractionBar"]);
            var cell = renderCell(rowIndex, columnIndex);
        ...
        _this.renderBody = function (quadrantType, showFrozenRowsOnly, showFrozenColumnsOnly) {
            ...
            return (React.createElement("div", null,
                React.createElement(TableBody, { allowMultipleSelection: allowMultipleSelection, cellRenderer: _this.bodyCellRenderer, focusedCell: focusedCell, grid: _this.grid, loading: _this.hasLoadingOption(loadingOptions, TableLoadingOption.CELLS), locator: _this.locator, onCompleteRender: onCompleteRender, onFocus: _this.handleFocus, onSelection: _this.getEnabledSelectionHandler(RegionCardinality.CELLS), renderBodyContextMenu: renderBodyContextMenu, renderMode: _this.getNormalizedRenderMode(), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, viewportRect: viewportRect, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd, numFrozenColumns: showFrozenColumnsOnly ? numFrozenColumns : undefined, numFrozenRows: showFrozenRowsOnly ? numFrozenRows : undefined }),
        ...
        _this.handleFocus = function (focusedCell) {
            ...
            CoreUtils.safeInvoke(_this.props.onFocus, focusedCell);
        };
    ...
    Table.prototype.render = function () {
        var _a = this.props, children = _a.children, className = _a.className, isRowHeaderShown = _a.isRowHeaderShown, loadingOptions = _a.loadingOptions, numRows = _a.numRows, useInteractionBar = _a.useInteractionBar;
        ...
        return (React.createElement("div", { className: classes, ref: this.refHandlers.rootTable, onScroll: this.handleRootScroll },
            React.createElement(TableQuadrantStack, { bodyRef: this.refHandlers.cellContainer, columnHeaderRef: this.refHandlers.columnHeader, grid: this.grid, handleColumnResizeGuide: this.handleColumnResizeGuide, handleColumnsReordering: this.handleColumnsReordering, handleRowResizeGuide: this.handleRowResizeGuide, handleRowsReordering: this.handleRowsReordering, isHorizontalScrollDisabled: this.shouldDisableHorizontalScroll(), isRowHeaderShown: isRowHeaderShown, isVerticalScrollDisabled: this.shouldDisableVerticalScroll(), loadingOptions: loadingOptions, numColumns: React.Children.count(children), numFrozenColumns: numFrozenColumnsClamped, numFrozenRows: numFrozenRowsClamped, numRows: numRows, onScroll: this.handleBodyScroll, quadrantRef: this.refHandlers.mainQuadrant, ref: this.refHandlers.quadrantStack, renderBody: this.renderBody, renderColumnHeader: this.renderColumnHeader, renderMenu: this.renderMenu, renderRowHeader: this.renderRowHeader, rowHeaderRef: this.refHandlers.rowHeader, scrollContainerRef: this.refHandlers.scrollContainer, useInteractionBar: useInteractionBar }),
    ...
    Table.prototype.maybeRenderSelectionResizeHotkeys = function () {
        var _a = this.props, allowMultipleSelection = _a.allowMultipleSelection, selectionModes = _a.selectionModes;
