...
var TruncatedFormat = (function (_super) {
    ...
    TruncatedFormat.prototype.renderPopover = function () {
        ...
        if (this.state.isPopoverOpen) {
            ...
            return (React.createElement(Popover, { className: Classes.TABLE_TRUNCATED_POPOVER_TARGET, tetherOptions: { constraints: constraints }, content: popoverContent, position: Position.BOTTOM, isOpen: true, onClose: this.handlePopoverClose, useSmartArrowPositioning: true },
                React.createElement(Icon, { iconName: "more" })));
        }
        else {
