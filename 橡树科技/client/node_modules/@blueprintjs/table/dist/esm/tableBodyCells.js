...
var TableBodyCells = (function (_super) {
    ...
    TableBodyCells.prototype.shouldComponentUpdate = function (nextProps) {
        return (!Utils.shallowCompareKeys(nextProps, this.props, { exclude: SHALLOW_COMPARE_BLACKLIST }) ||
    ...
    TableBodyCells.prototype.componentWillUpdate = function (nextProps) {
        ...
        var shouldResetBatcher = !Utils.shallowCompareKeys(this.props, nextProps, resetKeysBlacklist);
    ...
    TableBodyCells.prototype.render = function () {
        ...
        return React.createElement("div", { className: "bp-table-body-cells" }, cells);
    };
    // Render modes
    // ============
