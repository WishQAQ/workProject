...
import { AbstractComponent, Icon, Popover, Position, Utils as CoreUtils } from "@blueprintjs/core";
...
var ColumnHeaderCell = (function (_super) {
    ...
    ColumnHeaderCell.prototype.render = function () {
        ...
        var classes = classNames(spreadableProps.className, Classes.TABLE_COLUMN_HEADER_CELL, (_b = {},
            ...
            _b));
        return (React.createElement(HeaderCell, tslib_1.__assign({ isReorderable: this.props.isColumnReorderable, isSelected: this.props.isColumnSelected }, spreadableProps, { className: classes }),
            this.renderName(),
    ...
    ColumnHeaderCell.prototype.renderName = function () {
        ...
        var nameComponent = (React.createElement(LoadableContent, { loading: loading, variableLength: true }, renderName == null
            ? defaultName
    ...
    ColumnHeaderCell.prototype.maybeRenderDropdownMenu = function () {
        ...
        var content = CoreUtils.isFunction(renderMenu) ? renderMenu(index) : menu;
        return (React.createElement("div", { className: classes },
            React.createElement("div", { className: Classes.TABLE_TH_MENU_CONTAINER_BACKGROUND }),
            React.createElement(Popover, { tetherOptions: { constraints: constraints }, content: content, position: Position.BOTTOM, className: Classes.TABLE_TH_MENU, popoverDidOpen: this.handlePopoverDidOpen, popoverWillClose: this.handlePopoverWillClose, useSmartArrowPositioning: true },
                React.createElement(Icon, { iconName: menuIconName }))));
        var _b;
    };
