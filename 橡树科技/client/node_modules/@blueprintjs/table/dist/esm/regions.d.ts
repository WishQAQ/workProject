...
export declare type ColumnLoadingOption = "cells" | "column-header";
export declare const ColumnLoadingOption: {
    CELLS: ColumnLoadingOption;
    HEADER: ColumnLoadingOption;
};
export declare type RowLoadingOption = "cells" | "row-header";
export declare const RowLoadingOption: {
    CELLS: RowLoadingOption;
    HEADER: RowLoadingOption;
};
export declare type TableLoadingOption = ColumnLoadingOption | RowLoadingOption;
export declare const TableLoadingOption: {
