...
var TableQuadrant = (function (_super) {
    ...
    TableQuadrant.prototype.render = function () {
        ...
        var maybeMenu = isRowHeaderShown && core_1.Utils.safeInvoke(this.props.renderMenu);
        var maybeRowHeader = isRowHeaderShown && core_1.Utils.safeInvoke(this.props.renderRowHeader, showFrozenRowsOnly);
        var maybeColumnHeader = core_1.Utils.safeInvoke(this.props.renderColumnHeader, showFrozenColumnsOnly);
