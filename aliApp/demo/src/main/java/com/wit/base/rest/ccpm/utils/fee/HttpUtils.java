...
public class HttpUtils {
   ...
   public static  String doGetSSL(String url,Map<String, String> headers, Map<String, Object> params){
     ...
     * @return
     */
    public static String doPostByForm(String url,Map<String, String> headers,Map<String, Object> map) {
    	if (url.startsWith("https://")) {
  	      return doPostSSL(url,headers,map);
		}else{
	     return doPostHttp(url,headers,map);
		}
